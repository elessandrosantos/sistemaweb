            ...
            <div id="abaPrincipal" class="tab-pane container active">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">   
                        ...
                        <select value ="<?php echo($clogra);?>" name="LOGRA" class="form-control" id="idcbxLogradouro"><option>Logradouro</option></select> 
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">   
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">   
                        ...
                        <select value ="<?php echo($cidade);?>" name="CIDADE" class="form-control" id="idcbxCidade"><option>Cidade</option></select> 
                    </div>
                    <div class="form-group col-md-3">   
                        <label for="nmcbxEstado">Estado</label>
                        <select value ="<?php echo($estado);?>" name="ESTADO" class="form-control" id="idcbxEstado"><option>Estado</option></select> 
                    </div>
                    <div class="form-group col-md-3">   
                        <label for="nmcbxPais">Pais</label>
                        <select value ="<?php echo($pais);?>" name="COD_PAIS" class="form-control" id="idcbxPais"><option>Pais</option></select> 
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-2">   
            ...
            <div id="abaEnderecosEntrega" class="tab-pane container fade">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">   
                        ...
                        <input value ="<?php echo($clograent);?>" type="text" class="form-control" name="LOGRA_E" id="idgetLogradouroEnt" size="6" maxlength="6" placeholder=""/>
                    </div> 
                    <div class="form-group col-md-5">   
                        <label for="nmgetEndereco">Endereco</label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">   
                        ...
                        <input value ="<?php echo($cidadeent);?>" type="text" class="form-control" name="CIDADE_E" id="idgetCidadeEnt" size="40" maxlength="40" placeholder=""/>
                    </div> 
                    
                    <div class="form-group col-md-4">   
                        <label for="nmgetEstadoEnt">Estado</label>
                        <input value ="<?php echo($estadoent);?>" type="text" class="form-control" name="ESTADO_E" id="idgetEstadoEnt" size="40" maxlength="40" placeholder=""/>
                    </div> 
                </div>
                <div class="row">                    
                    <div class="form-group col-md-2">   
                        <label for="nmgetPais">Pais</label>
                        <input value ="<?php echo($paisent);?>" type="text" class="form-control" name="PAIS_E" id="idgetPaisEnt" size="4" maxlength="4" placeholder=""/>
                    </div> 
                </div>
            </div>
            <div id="abaDadosdeCobranca" class="tab-pane container fade">
                ...
                <div class="row">
                    <div class="form-group col-md-3">   
                        ...
                        <select value ="<?php echo($ccodban);?>" name="COD_BAN" class="form-control" id="idcbxBanco"><option>Banco</option></select> 
                    </div>
                    <div class="form-group col-md-3">   
                        <label for="nmgetCobranca">Cobranca</label>
                        <input value ="<?php echo($ccodcob);?>" type="text" class="form-control" name="COD_COB" id="idgetCobranca" size="1" maxlength="1" placeholder=""/>
                    </div> 
                    <div class="form-group col-md-1">   
            ...
            <div id="abaDemaisInformacoes" class="tab-pane container fade">
                ...
                <div class="row">
                    <div class="form-group col-md-12">   
                        ...
                        <input value ="<?php echo($mObs);?>" type="text" class="form-control" name="OBS" id="idtextObservacao" size="10" maxlength="10" placeholder=""/>
                    </div> 
                </div>
                <div class="row">     
                    <div class="form-group col-md-1">   
