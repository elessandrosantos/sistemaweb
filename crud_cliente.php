<html lang="pt-br">
    <head>
        <meta charset="UTF-8"/> 
        <title>Cadastro realizado com sucesso!, verifique seu email para o recebimento da senha de acesso.</title>
    </head>
    <body>
...
// Dados de Cobrança
        ...
        ?>
        <br/>    
        <a href="index.php?p=dlgpesqclientes"><input name="voltar" type="submit" id="voltar" value="voltar" /> </a>
    </body>
</html>